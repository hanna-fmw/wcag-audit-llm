- Run lighthouse https://www.example.com --output=json --output-path=report.json to generate report (in active folder / desktop) (make sure lighthouse is globally installed)
